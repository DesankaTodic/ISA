...
insert into foodstuff(name) values ('grasak')
insert into foodstuff(name) values ('pasulj')
insert into foodstuff(name) values ('sargarepa')
insert into foodstuff(name) values ('jagoda')
insert into foodstuff(name) values ('luk')
insert into foodstuff(name) values ('jabuka')
insert into foodstuff(name) values ('sljiva')
...
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (8,'Zora','Milut','1967-04-23', 'L','38',1,'true')
INSERT INTO user(email,password,role,accept) VALUES('sima','simasima','cook','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (9,'Sinisa','Milut','1964-05-29', 'XL','46',1,'true')
INSERT INTO user(email,password,role,accept) VALUES('dana','danadana','barman','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (10,'Dana','Zivan','1972-01-29', 'L','39',1,'true')
...
INSERT INTO user(email,password,role,accept) VALUES('jova','jova','barman','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (13,'Jovan','Nikolic','1967-04-23', 'L','38',1,'false')
INSERT INTO user(email,password,role,accept) VALUES('misa','misa','saladCook','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (14,'Misa','Peric','1964-05-29', 'XL','46',1,'false')
INSERT INTO user(email,password,role,accept) VALUES('zeljko','zeljko','grilledCook','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (15,'Zeljko','Maric','1972-01-29', 'L','39',1,'false')
INSERT INTO user(email,password,role,accept) VALUES('nema','nema','waiter','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (16,'Nemanja','Ratkovic','1978-02-21', 'XL','44',1,'false')
...
insert into tablee(reon,restaurant,exist) values (1,1,true)
insert into tablee(reon,restaurant,exist) values (1,1,true)
insert into reon(name,location,restaurant, number_table) values ('NorthCenter','northcenter part',1,3)
insert into tablee(reon,restaurant,exist) values (2,1,true)
insert into tablee(reon,restaurant,exist) values (2,1,true)
insert into tablee(reon,restaurant,exist) values (2,1,true)
insert into reon(name,location,restaurant, number_table) values ('EastCenter','eastcenter part',1,4)
insert into tablee(reon,restaurant,exist) values (3,1,true)
insert into tablee(reon,restaurant,exist) values (3,1,true)
insert into tablee(reon,restaurant,exist) values (3,1,true)
insert into tablee(reon,restaurant,exist) values (3,1,true)
insert into reon(name,location,restaurant, number_table) values ('East','east part',1,4)
insert into tablee(reon,restaurant,exist) values (4,1,true)
insert into tablee(reon,restaurant,exist) values (4,1,true)
insert into tablee(reon,restaurant,exist) values (4,1,true)
insert into tablee(reon,restaurant,exist) values (4,1,true)
...
insert into drink(name, price,description,restaurant,exist) values ('rakija',120,'zestoko',1,true)
insert into drink(name, price,description,restaurant,exist) values ('votka',180,'zestoko',1,true)
insert into drink(name, price,description,restaurant,exist) values ('tekila',150,'zestoko',1,true)
insert into drink(name, price,description,restaurant,exist) values ('vino',200,'vina',1,true)
insert into drink(name, price,description,restaurant,exist) values ('sok',90,'soksok',1,true)
insert into drink(name, price,description,restaurant,exist) values ('voda',60,'zestoko',1,true)


insert into meal(name, price,description,restaurant,exist) values ('supa',120,'corba',1,true)
insert into meal(name, price,description,restaurant,exist) values ('pasulj',180,'corba',1,true)
insert into meal(name, price,description,restaurant,exist) values ('biftek',150,'meso',1,true)
insert into meal(name, price,description,restaurant,exist) values ('musaka',200,'glavno jelo',1,true)
insert into meal(name, price,description,restaurant,exist) values ('meso',90,'glavno jelo',1,true)
insert into meal(name, price,description,restaurant,exist) values ('grasak',60,'corba',1,true)
...
insert into reserved_tables(id_restaurant,id_table,date,time,duration) values (1,3,'2017-02-27','02:00',2)
insert into reserved_tables(id_restaurant,id_table,date,time,duration) values (1,4,'2017-02-27','02:00',2)
insert into reserved_tables(id_restaurant,id_table,date,time,duration) values (1,7,'2017-02-28','05:00',3)
insert into reserved_tables(id_restaurant,id_table,date,time,duration) values (1,15,'2017-02-28','18:00',4)
insert into reserved_tables(id_restaurant,id_table,date,time,duration) values (1,16,'2017-02-28','18:00',4)
...
insert into reservation(id_guest,id_restaurant,date,time,duration,flag) values (1,1,'2017-02-28','05:00',3,'aktivna')
insert into reservation_reserved_tables(reservation_id,table_id) values (3,7)
insert into accepted_friends(reservation_id,friend_id) values (3,3)
insert into accepted_friends(reservation_id,friend_id) values (3,5)



insert into reservation(id_guest,id_restaurant,date,time,duration,flag) values (1,1,'2017-02-28','18:00',4,'aktivna')
insert into reservation_reserved_tables(reservation_id,table_id) values (4,15)
insert into reservation_reserved_tables(reservation_id,table_id) values (4,16)
insert into accepted_friends(reservation_id,friend_id) values (4,3)
...
INSERT INTO orderr(waiter,tablee,barman_state,cook_state,time_of_order,reservation,restaurant) VALUES (8,3,'kreirana','kreirana','2017-02-26 12:18:41.972',2,1)
INSERT INTO orderr(waiter,tablee,barman_state,cook_state,time_of_order,reservation,restaurant) VALUES (8,4,'kraj','kraj','2017-02-26 13:18:41.972',2,1)
...
--ocjene
insert into rating_all(reservation,guest,restaurant,restaurant_rating,service_rating,meal_rating,waiter)values(1,1,1,2,3,4,8)
insert into rating_all(reservation,guest,restaurant,restaurant_rating,service_rating,meal_rating,waiter)values(1,5,1,5,1,3,8)
insert into rating_all(reservation,guest,restaurant,restaurant_rating,service_rating,meal_rating,waiter)values(1,3,2,4,2,5,8)
insert into rating_all_meals(rating_id,meal_id) values (1,1)
insert into rating_all_meals(rating_id,meal_id) values (1,2)
...
--insert into city(country, name, state, map) values ('Olja', 'solja', 'bolja', '-27.470933, 153.023502')
---- Melbourne
